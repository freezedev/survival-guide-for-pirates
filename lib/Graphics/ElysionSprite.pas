  ...
  begin
    ...
    glPushMatrix;
      ...
      glBegin(GL_QUADS);
        ...
        glTexCoord2f(0, 1); 		
        glVertex3f(Position.X / ActiveWindow.Width, Position.Y / ActiveWindow.Height, -Position.Z);
        
        glTexCoord2f(0, 0); 
        glVertex3f( Position.X / ActiveWindow.Width, (Position.Y + Height) /  ActiveWindow.Height,  -Position.Z);
        
        glTexCoord2f(1, 0); 
        glVertex3f((Position.X + Width) / ActiveWindow.Width, (Position.Y + Height) /  ActiveWindow.Height, -Position.Z);
        
        glTexCoord2f(1,1);
        glVertex3f((Position.X + Width) / ActiveWindow.Width, Position.Y / ActiveWindow.Height, -Position.Z);
